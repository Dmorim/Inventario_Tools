def Comandos_Screen(self, parent):
    ...
    from Comandos.Comandos_Gerais.Comandos_Func import on_click_confirm, precu_porcent_entry_validate # Importa as funções on_click_confirm e precu_porcent_entry_validate do arquivo Comandos_Func da pasta Comandos
    from Comandos.Distorcao_Saldo.Comandos_Dist_Saldo import on_click_dist_saldo # Importa a função on_click_dist_saldo do arquivo Comandos_Dist_Saldo da pasta Comandos
