def Consulta_Total_Screen(self, root):
    ...
    frame_l = ctk.CTkFrame(Consulta_Screen, width=395,
                           height=203, border_width=2, border_color='silver')
    frame_r = ctk.CTkFrame(Consulta_Screen, width=395,
                           height=203, border_width=2, border_color='silver')
    ...
    ToolTip(val_inv_button,
            "Gera o valor do inventário com base no saldo e preço de custo dos produtos")
    ...
    ToolTip(precuplus_zer_button,
            "Produtos com preço de custo, compra e venda zerados")
