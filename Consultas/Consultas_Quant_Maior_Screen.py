def Quant_Maior_Screen(self, Consulta_Screen):    
    ...
    from Consultas.Consultas_Quant_Maior_List import List_Treeview_Screen
    ...
    val_ven_text = ctk.CTkLabel(hub, text= prod_get(f"Select count (*) from in01lan where quant > 999999 and dtpro between '{self.data_banco_inicial}' and '{self.data_banco_final}'"), width= 20, height= 2, font= ('', 14))
